...
static const PantheonTimecycleSlot pantheon_timecycle[PANTHEON_WEATHER_COUNT][8] = {
    /* clear */
    {
        ...
        {{ 88,  62, 178}, {238, 138,  88}, {250, 188, 120}, {110,  78,  92}, { 92,  40,  72},  58,  64, 1750.0f, 950.0f},
        {{ 36,  28,  92}, {150,  72, 132}, {120,  78, 148}, { 72,  52,  88}, { 48,  22,  58},  52,  48, 1400.0f, 650.0f},
    ...
    /* overcast — baby-blue bias in daytime slots (soft SA-style haze, not flat gray). */
    {
        {{ 18,  24,  38}, { 52,  58,  70}, { 68,  70,  74}, {56,  58,  62}, { 16,  18,  22},  92,  28, 900.0f, 300.0f},
        {{ 58,  72,  98}, {142, 168, 206}, {168, 182, 198}, {70,  74,  82}, { 22,  24,  30}, 128,  34, 1150.0f, 480.0f},
        {{ 72,  88, 118}, {158, 186, 224}, {188, 200, 214}, {76,  80,  88}, { 24,  26,  32}, 148,  32, 1300.0f, 600.0f},
        {{ 78,  94, 122}, {162, 190, 228}, {192, 202, 210}, {78,  82,  88}, { 24,  26,  30}, 156,  30, 1350.0f, 650.0f},
